...
const UserPrivacyPolicyScreen = ({navigation}) => {
  ...
  return (
   ...
   <View  style={styles.wrapper1}>
    <View style={styles.wrapper2}>
     ...
     <View>
         <Text style={{ color:'white',textAlign:'center',fontSize:normalizeFont(22),fontWeight:'700' }}>Privacy Policy</Text>
     </View>
...
export default UserPrivacyPolicyScreen;
