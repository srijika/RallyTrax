...
const UserTransactionHistoryScreen = ({navigation}) => {
   ...
   <>
    ...
    <View style={styles.wrapper2}>
     ...
     <ArrowBack  />
      ...
      <Text style={{ color:'white',marginTop:windowHeight/12, marginLeft:windowWidth/30,fontSize:normalizeFont(22),fontWeight:'700' }}>User Transaction History</Text>
     <TransactionHistory color_name={'red'}/>
     <TransactionHistory color_name={'red'} />
     <TransactionHistory color_name={'red'}/>
     <TransactionHistory color_name={'red'} />
     <TransactionHistory color_name={'red'} />
