...
const BusinessPaymentMethods = ({navigation}) => {
   ...
   <>
    ...
    <View style={styles.wrapper2}>
     ...
     <ArrowBack />
      ...
      <Text style={{ color:'white',marginTop:windowHeight/12, marginLeft:windowWidth/30,fontSize:normalizeFont(22),fontWeight:'700' }}>Payment Methods</Text>
     <PaymentMethods />
     <PaymentMethods />
