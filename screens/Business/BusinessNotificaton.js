...
const BusinessNotificaton = ({navigation}) => {
   ...
   <>
    ...
    <View style={styles.wrapper2}>
     ...
     <ArrowBack />
      ...
      <Text style={{ color:'white',marginTop:windowHeight/12, marginLeft:windowWidth/30,fontSize:normalizeFont(22),fontWeight:'700' }}>Notifications</Text>
     <Notification />
     <Notification />
     <Notification />
     <Notification />
...
export default BusinessNotificaton;
